...
//						 		"font-family:Arial; font-size:20px;color:black'>"+ value.text +"</span>");
	...
	$('#helpDialog').click(function(event){
	 ...
	 $("#helpDialog").append("<div id='gameDivHelp' style='z-index:2000;" +
		 		"border-style:solid;border:2px;"+
				"background:rgb(230,152,83);top:0px;width:585px;height:50px'></div>");
