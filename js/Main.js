...
//end		
		...
		if (currentPage.videos !== undefined) {
			 for (var i = 0; i < currentPage.videos.length; i++) {
				 $("#bodyDiv").append(
				 "<button id='video"+i+"' class='btn_games' style='z-index: 3999; position: absolute; "
		...
		if (currentPage.inputs !== undefined && currentPage.inputs != null) {
		 ...
		 $("#bodyDiv").append("<img src='images/logo/avatar.gif' id='avatar' style='position:absolute;z-index;19999;top:1500px;left:1380px;'" +
